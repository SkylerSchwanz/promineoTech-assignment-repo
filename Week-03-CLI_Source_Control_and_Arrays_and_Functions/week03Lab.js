...
myTodoList.push("Wash dishes", "Walk dog", "Take out the trash");
myTodoList.splice(1, 1);
console.log(myTodoList);

let yourTodoList = new Array();
yourTodoList.push('Go to supermarket', 'Practice guitar', 'Attend meeting');
...
let whichArrayIsLonger = (array1, array2) => {
    if (array1.length > array2.length) { return array1 } else if (array2 > array1) { return array2 } else { return false };
};
/* ↑ YOUR CODE HERE ↑ */
